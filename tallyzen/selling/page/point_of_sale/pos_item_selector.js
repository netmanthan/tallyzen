...
tallyzen.PointOfSale.ItemSelector = class {
	...
	get_items({start = 0, page_length = 40, search_term=''}) {
		...
		return frappe.call({
			method: "tallyzen.selling.page.point_of_sale.point_of_sale.get_items",
			freeze: true,
	...
	make_search_bar() {
		...
		this.item_group_field = frappe.ui.form.make_control({
			df: {
				...
				get_query: function () {
					return {
						query: 'tallyzen.selling.page.point_of_sale.point_of_sale.item_group_query',
						filters: {
