...
from tallyzen.controllers.accounts_controller import update_child_qty_rate
from tallyzen.maintenance.doctype.maintenance_schedule.test_maintenance_schedule import (
	make_maintenance_schedule,
)
from tallyzen.maintenance.doctype.maintenance_visit.test_maintenance_visit import (
	make_maintenance_visit,
)
from tallyzen.manufacturing.doctype.blanket_order.test_blanket_order import make_blanket_order
from tallyzen.selling.doctype.product_bundle.test_product_bundle import make_product_bundle
from tallyzen.selling.doctype.sales_order.sales_order import (
	WarehouseRequired,
	make_delivery_note,
...
class TestSalesOrder(FrappeTestCase):
	...
	def test_drop_shipping(self):
		from tallyzen.buying.doctype.purchase_order.purchase_order import update_status
		from tallyzen.selling.doctype.sales_order.sales_order import (
			make_purchase_order_for_default_supplier,
		)
		from tallyzen.selling.doctype.sales_order.sales_order import update_status as so_update_status
	...
	def test_product_bundles_in_so_are_replaced_with_bundle_items_in_po(self):
		...
		"""
		from tallyzen.selling.doctype.sales_order.sales_order import make_purchase_order
	...
	def test_make_work_order(self):
		from tallyzen.selling.doctype.sales_order.sales_order import get_work_order_items
	...
	def test_work_order_pop_up_from_sales_order(self):
		...
		from tallyzen.controllers.item_variant import create_variant
		from tallyzen.manufacturing.doctype.production_plan.test_production_plan import make_bom
		from tallyzen.selling.doctype.sales_order.sales_order import get_work_order_items
	...
	def test_so_cancellation_after_work_order_submission(self):
		...
		Expected result: Sales Order should not get cancelled
		"""
		from tallyzen.manufacturing.doctype.work_order.test_work_order import make_wo_order_test_record
	...
	def test_so_back_updated_from_wo_via_mr(self):
		...
		from tallyzen.manufacturing.doctype.work_order.work_order import (
			make_stock_entry as make_se_from_wo,
		)
		from tallyzen.stock.doctype.material_request.material_request import raise_work_orders
