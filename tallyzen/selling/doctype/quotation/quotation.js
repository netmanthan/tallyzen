...
tallyzen.accounts.taxes.setup_tax_validations("Sales Taxes and Charges Template");
tallyzen.accounts.taxes.setup_tax_filters("Sales Taxes and Charges");
tallyzen.pre_sales.set_as_lost("Quotation");
...
tallyzen.selling.QuotationController = class QuotationController extends tallyzen.selling.SellingController {
	onload(doc, dt, dn) {
	...
	set_dynamic_field_label(){
		if (this.frm.doc.quotation_to == "Customer") {
			...
			this.frm.fields_dict.party_name.get_query = function() {
				return{	query: "tallyzen.controllers.queries.lead_query" }
			}
	...
	get_lead_details() {
		...
		frappe.call({
			method: "tallyzen.crm.doctype.lead.lead.get_lead_details",
			args: {
...
cur_frm.script_manager.make(tallyzen.selling.QuotationController);
