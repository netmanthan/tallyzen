...
tallyzen.bom.BomConfigurator = class BomConfigurator extends tallyzen.TransactionController {
	conversion_rate(doc) {
...
extend_cscript(cur_frm.cscript, new tallyzen.bom.BomConfigurator({frm: cur_frm}));