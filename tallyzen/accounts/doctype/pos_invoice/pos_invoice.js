...
tallyzen.accounts.pos.setup("POS Invoice");
tallyzen.selling.POSInvoiceController = class POSInvoiceController extends tallyzen.selling.SellingController {
	settings = {};
...
extend_cscript(cur_frm.cscript, new tallyzen.selling.POSInvoiceController({ frm: cur_frm }))
