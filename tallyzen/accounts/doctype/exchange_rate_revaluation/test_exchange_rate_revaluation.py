...
from tallyzen import get_default_cost_center
...
from tallyzen.accounts.test.accounts_mixin import AccountsTestMixin
...
class TestExchangeRateRevaluation(AccountsTestMixin, FrappeTestCase):
	...
	def test_04_get_account_details_function(self):
		...
		from tallyzen.accounts.doctype.exchange_rate_revaluation.exchange_rate_revaluation import (
			get_account_details,
		)
