...
class RepostAccountingLedger(Document):
	...
	def generate_preview(self):
		...
		rendered_page = frappe.render_template(
			"tallyzen/accounts/doctype/repost_accounting_ledger/repost_accounting_ledger.html",
	...
	def on_submit(self):
		if len(self.vouchers) > 1:
			...
			frappe.enqueue(
				method="tallyzen.accounts.doctype.repost_accounting_ledger.repost_accounting_ledger.start_repost",
