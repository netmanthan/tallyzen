...
import tallyzen
from tallyzen.accounts.doctype.process_payment_reconciliation.process_payment_reconciliation import (
	is_any_doc_running,
)
...
from tallyzen.controllers.accounts_controller import get_advance_payment_entries_for_regional
...
class PaymentReconciliation(Document):
	...
	def get_jv_entries(self):
		...
		dr_or_cr = (
			...
			if tallyzen.get_party_account_type(self.party_type) == "Receivable"
				...
				"accounts": [
					{
						...
						"cost_center": inv.cost_center or tallyzen.get_default_cost_center(company),
