// Copyright (c) 2019, TallyZEN Technologies and Netmanthan Contributors
...
frappe.ui.form.on("Bank Statement Import", {
	...
	export_errored_rows(frm) {
		open_url_post(
			"/api/method/tallyzen.accounts.doctype.bank_statement_import.bank_statement_import.download_errored_template",
			{
