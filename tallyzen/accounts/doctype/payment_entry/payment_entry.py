...
import tallyzen
from tallyzen.accounts.doctype.bank_account.bank_account import (
...
from tallyzen.accounts.doctype.journal_entry.journal_entry import get_default_bank_cash_account
...
from tallyzen.controllers.accounts_controller import (
	AccountsController,
...
class PaymentEntry(AccountsController):
	...
	def set_payment_req_status(self):
		from tallyzen.accounts.doctype.payment_request.payment_request import update_payment_req_status
	...
	def add_party_gl_entries(self, gl_entries):
		if self.party_account:
			...
			dr_or_cr = (
				"credit" if tallyzen.get_party_account_type(self.party_type) == "Receivable" else "debit"
			)
...
def get_reference_details(reference_doctype, reference_name, party_account_currency):
	...
	company_currency = ref_doc.get("company_currency") or tallyzen.get_company_currency(
		ref_doc.company
	)
