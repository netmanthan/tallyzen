...
class Account(NestedSet):
	...
	def autoname(self):
		from tallyzen.accounts.utils import get_autoname_with_number

		self.name = get_autoname_with_number(self.account_number, self.account_name, self.company)

	def validate(self):
		from tallyzen.accounts.utils import validate_field_number
				...
				doc.update(
					{
						...
						else tallyzen.get_company_currency(company),
