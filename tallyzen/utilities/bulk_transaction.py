...
def task(doc_name, from_doctype, to_doctype):
	from tallyzen.accounts.doctype.payment_entry import payment_entry
	from tallyzen.accounts.doctype.purchase_invoice import purchase_invoice
	from tallyzen.accounts.doctype.sales_invoice import sales_invoice
	from tallyzen.buying.doctype.purchase_order import purchase_order
	from tallyzen.buying.doctype.supplier_quotation import supplier_quotation
	from tallyzen.selling.doctype.quotation import quotation
	from tallyzen.selling.doctype.sales_order import sales_order
	from tallyzen.stock.doctype.delivery_note import delivery_note
	from tallyzen.stock.doctype.purchase_receipt import purchase_receipt
