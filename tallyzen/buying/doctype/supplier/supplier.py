...
from tallyzen.accounts.party import (  # noqa
	get_dashboard_info,
	get_timeline_data,
	validate_party_accounts,
)
from tallyzen.controllers.website_list_for_contact import add_role_for_portal_user
...
class Supplier(TransactionBase):
	...
	def create_primary_contact(self):
		from tallyzen.selling.doctype.customer.customer import make_contact
	...
	def create_primary_address(self):
		...
		from tallyzen.selling.doctype.customer.customer import make_address
