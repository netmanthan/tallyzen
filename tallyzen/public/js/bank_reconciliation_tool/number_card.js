...
tallyzen.accounts.bank_reconciliation.NumberCardManager = class NumberCardManager {
	constructor(opts) {
	...
	make_cards() {
		...
		chart_data.forEach((summary) => {
			let number_card = new tallyzen.accounts.NumberCard(summary);
...
tallyzen.accounts.NumberCard = class NumberCard {
	constructor(options) {
