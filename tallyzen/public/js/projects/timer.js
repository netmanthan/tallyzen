frappe.provide("tallyzen.timesheet");

tallyzen.timesheet.timer = function(frm, row, timestamp=0) {
	...
	tallyzen.timesheet.control_timer(frm, dialog, row, timestamp);
	dialog.show();
};

tallyzen.timesheet.control_timer = function(frm, dialog, row, timestamp=0) {
