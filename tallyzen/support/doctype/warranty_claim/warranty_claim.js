...
frappe.provide("tallyzen.support");
...
tallyzen.support.WarrantyClaim = class WarrantyClaim extends frappe.ui.form.Controller {
	refresh() {
...
extend_cscript(cur_frm.cscript, new tallyzen.support.WarrantyClaim({frm: cur_frm}));
