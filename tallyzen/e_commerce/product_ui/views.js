tallyzen.ProductView =  class {
	...
	*/
	...
	get_item_filter_data(from_filters=false) {
		...
		frappe.call({
			method: "tallyzen.e_commerce.api.get_product_filter_data",
			args: {
				query_args: args
			},
