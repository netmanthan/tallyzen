...
tallyzen.landed_cost_taxes_and_charges.setup_triggers("Subcontracting Order");
...
tallyzen.buying.SubcontractingOrderController = class SubcontractingOrderController {
	setup() {
	...
	make_subcontracting_receipt() {
		frappe.model.open_mapped_doc({
			method: 'tallyzen.subcontracting.doctype.subcontracting_order.subcontracting_order.make_subcontracting_receipt',
			frm: cur_frm,
...
extend_cscript(cur_frm.cscript, new tallyzen.buying.SubcontractingOrderController({ frm: cur_frm }));