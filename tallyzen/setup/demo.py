...
from tallyzen.buying.doctype.purchase_order.purchase_order import make_purchase_invoice
...
def setup_demo_data():
	...
	capture("demo_data_creation_started", "tallyzen")
	try:
		...
		capture("demo_data_creation_failed", "tallyzen", properties={"exception": frappe.get_traceback()})
		raise
	capture("demo_data_creation_completed", "tallyzen")
...
def clear_demo_data():
	...
	capture("demo_data_erased", "tallyzen")
	try:
