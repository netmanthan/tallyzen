...
import tallyzen
from tallyzen.setup.default_energy_point_rules import get_default_energy_point_rules
from tallyzen.setup.doctype.incoterm.incoterm import create_incoterms

from .default_success_action import get_default_success_action

default_mail_footer = """<div style="padding: 7px; text-align: right; color: #888"><small>Sent via
	<a style="color: #888" href="http://tallyzen.org">TallyZEN</a></div>"""
...
def check_setup_wizard_not_completed():
	if cint(frappe.db.get_single_value("System Settings", "setup_complete") or 0):
		message = """TallyZEN can only be installed on a fresh site where the setup wizard is not completed.
...
def check_frappe_version():
	...
	tallyzen_version = major_version(tallyzen.__version__)

	if frappe_version == tallyzen_version:
		return

	click.secho(
		f"You're attempting to install TallyZEN version {tallyzen_version} with Frappe version {frappe_version}. "
...
def add_standard_navbar_items():
	...
	tallyzen_navbar_items = [
		{
			"item_label": "Documentation",
			"item_type": "Route",
			"route": "https://docs.tallyzen.com/",
			"is_standard": 1,
		},
		{
			"item_label": "User Forum",
			"item_type": "Route",
			"route": "https://discuss.tallyzen.com",
			"is_standard": 1,
		},
		{
			"item_label": "TallyZEN School",
			"item_type": "Route",
			"route": "https://tzen.tallyzen.com?utm_source=in_app",
			"is_standard": 1,
		},
		{
			"item_label": "Report an Issue",
			"item_type": "Route",
			"route": "https://github.com/netmanthan/tallyzen/issues",
			"is_standard": 1,
		},
	]
	...
	for item in tallyzen_navbar_items:
...
def add_app_name():
	frappe.db.set_single_value("System Settings", "app_name", "TallyZEN")
