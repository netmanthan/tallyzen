...
tallyzen.landed_cost_taxes_and_charges.setup_triggers("Landed Cost Voucher");
tallyzen.stock.LandedCostVoucher = class LandedCostVoucher extends tallyzen.stock.StockController {
	setup() {
		var me = this;
...
cur_frm.script_manager.make(tallyzen.stock.LandedCostVoucher);
