...
from tallyzen.controllers.item_variant import ItemTemplateCannotHaveStock
from tallyzen.stock.serial_batch_bundle import SerialBatchBundle
...
class StockLedgerEntry(Document):
	...
	def validate_and_set_fiscal_year(self):
		if not self.fiscal_year:
			...
			from tallyzen.accounts.utils import validate_fiscal_year
	...
	def block_transactions_against_group_warehouse(self):
		from tallyzen.stock.utils import is_group_warehouse
