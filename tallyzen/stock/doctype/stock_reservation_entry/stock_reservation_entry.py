...
class StockReservationEntry(Document):
	...
	def auto_reserve_serial_and_batch(self, based_on: str = None) -> None:
		...
		if (
			...
			from tallyzen.stock.doctype.batch.batch import get_available_batches
			from tallyzen.stock.doctype.serial_no.serial_no import get_serial_nos_for_outward
			from tallyzen.stock.serial_batch_bundle import get_serial_nos_batch
...
def create_stock_reservation_entries_for_so_items(
	...
	from tallyzen.selling.doctype.sales_order.sales_order import get_unreserved_qty
