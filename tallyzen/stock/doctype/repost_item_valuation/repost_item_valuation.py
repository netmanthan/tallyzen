...
import tallyzen
from tallyzen.accounts.general_ledger import validate_accounting_period
from tallyzen.accounts.utils import get_future_stock_vouchers, repost_gle_for_stock_vouchers
from tallyzen.stock.stock_ledger import (
...
def repost_gl_entries(doc):
	if not cint(tallyzen.is_perpetual_inventory_enabled(doc.company)):
		return
