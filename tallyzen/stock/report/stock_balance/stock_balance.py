...
import tallyzen
from tallyzen.stock.doctype.inventory_dimension.inventory_dimension import get_inventory_dimensions
from tallyzen.stock.doctype.warehouse.warehouse import apply_warehouse_filter
from tallyzen.stock.report.stock_ageing.stock_ageing import FIFOSlots, get_average_age
from tallyzen.stock.utils import add_additional_uom_columns
...
class StockBalanceReport(object):
	...
	def set_company_currency(self) -> None:
		if self.filters.get("company"):
			self.company_currency = tallyzen.get_company_currency(self.filters.get("company"))
		else:
