...
from tallyzen.controllers.sales_and_purchase_return import get_rate_for_return
from tallyzen.controllers.stock_controller import StockController
from tallyzen.stock.doctype.item.item import set_item_default
from tallyzen.stock.get_item_details import get_bin_details, get_conversion_factor
...
class SellingController(StockController):
	...
	def set_missing_lead_customer_details(self, for_validate=False):
		...
		if customer:
			from tallyzen.accounts.party import _get_party_details
			...
			from tallyzen.crm.doctype.lead.lead import get_lead_details
	...
	def validate_items(self):
		...
		from tallyzen.controllers.buying_controller import validate_item_type
