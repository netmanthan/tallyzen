...
from tallyzen.accounts.utils import cancel_exchange_gain_loss_journal, get_fiscal_year
...
from tallyzen.stock.doctype.inventory_dimension.inventory_dimension import (
	get_evaluated_inventory_dimension,
)
from tallyzen.stock.stock_ledger import get_items_to_be_repost
...
class StockController(AccountsController):
	...
	def make_gl_entries(self, gl_entries=None, from_repost=False):
		...
		if (
			cint(tallyzen.is_perpetual_inventory_enabled(self.company))
	...
	def clean_serial_nos(self):
		from tallyzen.stock.doctype.serial_no.serial_no import clean_serial_no_string
	...
	def make_sl_entries(self, sl_entries, allow_negative_stock=False, via_landed_cost_voucher=False):
		from tallyzen.stock.stock_ledger import make_sl_entries
	...
	def validate_warehouse(self):
		from tallyzen.stock.utils import validate_disabled_warehouse, validate_warehouse_company
	...
	def validate_putaway_capacity(self):
		...
		from tallyzen.stock.doctype.putaway_rule.putaway_rule import get_available_putaway_capacity
...
def get_accounting_ledger_preview(doc, filters):
	from tallyzen.accounts.report.general_ledger.general_ledger import get_columns as get_gl_columns
...
def get_stock_ledger_preview(doc, filters):
	from tallyzen.stock.report.stock_ledger.stock_ledger import get_columns as get_sl_columns
